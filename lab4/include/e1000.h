/* e1000.h - information for Intel 82545EM NIC */
...
#define E1000_RDSIZE 		sizeof(struct 	e1000_rx_desc)
#define E1000_TDSIZE 		sizeof(struct 	e1000_tx_desc)

static 	inline 	void 	e1000_io_writel(
	uint32 	iobase,
	uint32 	reg,
	uint32 	val
	)
...
static 	inline 	uint32 	e1000_io_readl(
	uint32 	iobase,
	uint32 	reg
	)
{
...
#define e1000_io_flush(iobase)  					\
	e1000_io_readl((iobase), E1000_STATUS);
